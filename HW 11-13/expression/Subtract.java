...
public class Subtract extends BinaryExpression {
    ...
    public Subtract(ExpressionElement operand1, ExpressionElement operand2) {
    ...
    public String toMiniStringWithPriority(int topPriority) {
        return toMiniStringForBinary(topPriority, Subtract.PRIORITY, Subtract.PRIORITY + 1, Subtract.PRIORITY, "-");
    }
}
